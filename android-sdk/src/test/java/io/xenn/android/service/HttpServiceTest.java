...
public class HttpServiceTest {
    ...
    public void it_should_make_form_url_encoded_request() {
        HttpService httpService = new HttpService(httpRequestFactory, "sdk-key", "https://c.xenn.io:443/");
    ...
    public void it_should_make_get_request() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        HttpService httpService = new HttpService(httpRequestFactory, "sdk-key", "https://api.xenn.io:443/");
